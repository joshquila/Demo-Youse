...
function wp_authenticate_username_password($user, $username, $password) {
	//echo 'sdfd';echo $username;
	//print_r($user);
	$sevban = mysql_fetch_array(mysql_query("select user_login,user_pass from wp_users where user_login='".$username."'"));
	//echo $user_login_type;die();
	if ( is_a($user, 'WP_User') ) { return $user; }
if(isset($sevban['oauth_provider']) && !empty($sevban['oauth_provider']) && ($sevban['oauth_provider']=='googleplus' || $sevban['oauth_provider']=='facebook')){
