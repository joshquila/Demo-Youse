...
function wp_update_term( $term_id, $taxonomy, $args = array() ) {
	...
	$name = wp_unslash($name);
	$description = wp_unslash($description);
	$description_back = wp_unslash($description_back);
	$cat_note = wp_unslash($cat_note);
	...
	$wpdb->update( $wpdb->term_taxonomy, compact( 'term_id', 'taxonomy', 'description','description_back','cat_note', 'parent' ), array( 'term_taxonomy_id' => $tt_id ) );
